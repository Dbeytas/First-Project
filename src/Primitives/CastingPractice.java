...
public class CastingPractice {
    public static void main(String[] args) {
        //implicit Casting goes from smaller to do larger,java do outomatically
        int number1 = 23;
       ...
       // short sum1 by1 + by2; compile time error (due to numeric promotion )
        //java  wants to store the result in to larger data type(int).That is why it is not compiling
       ...
       // short sum3 = (short) by1+ (short) by2;this is still individual casting for each variable
        ...
        int price =(int) 750.99;//this is already double ,we are going to cast it to (int)
