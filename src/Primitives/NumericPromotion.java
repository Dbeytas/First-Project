...
public class NumericPromotion {
    public static void main(String[] args) {
        ...
        int result = b1+b2;//numeric promotion happens and java promotes smaller data types to int
        int i1 = 4;
        double d1= i1;
        ...
        double d4 = 1.2;
        double result5 = f1 + d4 ;//numeric promotion happens and java promotes to larger data type
        char c =23;
